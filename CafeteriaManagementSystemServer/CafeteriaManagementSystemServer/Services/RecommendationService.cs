...
namespace CafeteriaManagementSystemServer.Services
{
    public class RecommendationService
    {
        ...
        public Response GetRecommendation(RecommendatioData data)
        {
            ...
            Response response = new Response(Constant.SUCCESS_MESSAGE, Constant.SUCCESS_STATUS, Constant.SUCCESSFULLY_ADDED_FEEDBACK, recommendedItem, "showrecommendation");
            return response;
        }
    }
}
