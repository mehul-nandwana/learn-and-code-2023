    ...
    public class FoodService:IFoodService
    {
        ...
        public Response AddFoodItem(Food food)
        {
            ...
            try
            {
                ...
                _notificationService.AddNotification(Models.Constant.ADD_FOOD_NOTIFICATION,food.Name + "Added");
        ...
        public Response UpdateFoodItem(Food food)
        {
            ...
            try
            {
                ...
                _notificationService.AddNotification(Models.Constant.UPDATE_FOOD__NOTIFICATION, food.Name + "Updated");
        ...
        public Response DeleteFoodItem(int id)
        {
            try    
            {
                ...
                _notificationService.AddNotification(Models.Constant.UPDATE_FOOD__NOTIFICATION, FOOD_ITEM_DELETED);
