...
namespace CafeteriaManagementSystemServer.Services
{
    public class FoodService : IFoodService
    {
        ...
        public Response AddFoodItem(Food food)
        {
            ...
            {
                return new Response(ex.Message, foodItem, Constant.ADMIN_LOGIN);
            }
        }
        ...
        public Response UpdateFoodItem(Food food)
        {
            ...
            try
            {
                foodItem = _foodRepository.GetFood(food.Name);
        ...
        public Response DeleteFoodItem(int id)
        {
            try
            {
                ...
                _notificationService.AddNotification(Constant.DELETE_FOOD_NOTIFICATION, CreateDeleteFoodMessage(food.Name));
        ...
        public Response GetDiscardItem()
        {
            try
            {
                ...
                return new Response(Constant.SHOW_DISCARD_ITEM_DATA, foods, Constant.SHOW_DISCARD_ITEM);
            }
            catch (Exception ex)
            {
        ...
        public Response GetDiscardedItemForAddingFeedback(int userId)
        {
            try
            {
                ...
                return new Response(Constant.SHOW_DISCARD_ITEM_DATA, discardItemData, Constant.SHOW_DISCARD_ITEM_FOR_FEEDBACK);
            }
            catch (Exception ex)
            {
                return new Response(ex.Message, userId, Constant.CHEF_LOGIN);
            }
        }

        public Response GetFoodItems(int userId)
        {
            try
            {
                List<FoodItem> foodItems = _foodRepository.GetFoodItems();
                return new Response(Constant.SUCCESSFULL, foodItems, Constant.EMPLOYEE_LOGIN);

            }
            catch (Exception ex)
            {
                return new Response(Constant.FAILURE_STATUS, string.Empty, Constant.EMPLOYEE_LOGIN);
        ...
        private string CreateDeleteFoodMessage(string foodName)
        {
            return $" {foodName} has been deleted.";
        }
    }
}
