    ...
    public class FeedbackService
    {
        ...
        public Response AddFeedback(FeedBackData feedbackData)
        {
            ...
            try
            {
                ...
                Response response = new Response(Constant.SUCCESS_MESSAGE, Constant.SUCCESS_STATUS, feedback.UserId.ToString(), feedback.UserId, "employee");
                return response;
            }
            catch (Exception ex)
            {
                Response response = new Response(Constant.FAILURE_MESSAGE, Constant.SUCCESS_STATUS, Constant.FAILURE_ADDED_FEEDBACK, feedback.UserId, "employee");
                return response;
            }
        }
        public Response GetFeedback( )
        {
            ...
            {
                Response response = new Response(Constant.FAILURE_MESSAGE, Constant.SUCCESS_STATUS, Constant.FAILURE_GET_FEEDBACK, "", "employee");
                return response;
            }
        }
