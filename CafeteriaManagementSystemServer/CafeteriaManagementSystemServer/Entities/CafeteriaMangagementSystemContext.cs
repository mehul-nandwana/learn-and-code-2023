...
namespace CafeteriaManagementSystemServer.Models
{
    public partial class CafeteriaMangagementSystemContext : DbContext
    {
        ...
        public virtual DbSet<DetailFeedback> DetailFeedbacks { get; set; } = null!;
        public virtual DbSet<DiscardItem> DiscardItems { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DetailFeedback>(entity =>
            {
                ...
                entity.HasOne(d => d.Menu)
                    .WithMany(p => p.DetailFeedbacks)
                    .HasForeignKey(d => d.MenuId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_DetailFeedback_FoodItems");
            });

            modelBuilder.Entity<DiscardItem>(entity =>
            {
                entity.ToTable("DiscardItem");

                entity.Property(e => e.Id).HasColumnName("id");

                entity.Property(e => e.FoodId).HasColumnName("foodId");

                entity.Property(e => e.GetDetailFeedback).HasColumnName("getDetailFeedback");
                ...
                entity.HasOne(d => d.Food)
                    .WithMany(p => p.DiscardItems)
                    .HasForeignKey(d => d.FoodId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_DiscardItem_FoodItems");
            });
            ...
            modelBuilder.Entity<FoodItem>(entity =>
            {
                ...
                entity.Property(e => e.Spicelevel).HasColumnName("spicelevel");

                entity.Property(e => e.Sweet).HasColumnName("sweet");
            });
            ...
            modelBuilder.Entity<UserPreference>(entity =>
            {
                ...
                entity.Property(e => e.IsVegeterian)
                    .HasMaxLength(50)
                    .IsUnicode(false)
