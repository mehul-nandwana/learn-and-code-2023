...
namespace CafeteriaRecomendationEngineClient.Client
{
    public class ClientHandler
    {
        ...
        private RequestProcessor _processor = new RequestProcessor();
        ...
        private void HandleCommunication()
        {
            ...
            {
                Console.WriteLine("Error during communication: {0}", ex);
            }
        }

        private void SendRequest(CustomProtocolParameters request)
        {
